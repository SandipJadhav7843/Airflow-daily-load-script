...
def main(date):
    ...
    input_path = f"hdfs://10.140.0.2:8020/tmp/input_data/orders/orders_{date}.csv"
    ...
    output_path = f"hdfs://10.140.0.2:8020/tmp/output_data/orders/processed_orders_{date}.csv"
